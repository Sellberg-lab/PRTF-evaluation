...
for i,particle in enumerate(particleList):
    ...
    command1="cp /home/elsin/scratch/test_particles/"+particle+"/particle_diffracted_wave.h5"
    command2="cp /home/elsin/scratch/test_particles/"+particle+"/particle_shape.hdf5"
    command3="cp /home/elsin/scratch/test_particles/"+particle+"/particle_support.h5"
